...
import 'home_page_m_a_i_n_copy_copy_model.dart';
export 'home_page_m_a_i_n_copy_copy_model.dart';

class HomePageMAINCopyCopyWidget extends StatefulWidget {
  const HomePageMAINCopyCopyWidget({super.key});

  @override
  State<HomePageMAINCopyCopyWidget> createState() =>
      _HomePageMAINCopyCopyWidgetState();
}

class _HomePageMAINCopyCopyWidgetState extends State<HomePageMAINCopyCopyWidget>
    with TickerProviderStateMixin {
  late HomePageMAINCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageMAINCopyCopyModel());
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            ...
                                            child: Card58TransferDetailsWidget(
                                              roomInfo: listViewRoomInfoRecord,
                                            ),
                                          );
                                        },
                                ...
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Hero(
                                          tag: searchResultItem.roomImage,
                                          transitionOnUserGestures: true,
                                          child: ClipRRect(
                                            borderRadius: BorderRadius.only(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  FFAppState().optionVisibility = false;
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('AnalyzeRoomCopy');
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        if (FFAppState().isOptionsExpanded) {
                          ...
                          FFAppState().optionVisibility = true;
                          setState(() {});
                          if (animationsMap[
                                  'containerOnActionTriggerAnimation1'] !=
                              null) {
