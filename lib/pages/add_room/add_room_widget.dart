...
class _AddRoomWidgetState extends State<AddRoomWidget> {
  ...
  void initState() {
    ...
    _model.roomnameTextController ??=
        TextEditingController(text: '방 이름을 입력해주세요');
    _model.roomnameFocusNode ??= FocusNode();

    _model.roomadressTextController ??=
        TextEditingController(text: '주소입력을 통해 값을 넣어주세요');
    _model.roomadressFocusNode ??= FocusNode();
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 0.0),
                  child: TextFormField(
                    controller: _model.roomadressTextController,
                    focusNode: _model.roomadressFocusNode,
                    autofocus: true,
                    readOnly: true,
                    obscureText: false,
                    decoration: InputDecoration(
                    ...
                    validator: _model.roomadressTextControllerValidator
                        .asValidator(context),
                  ),
                ),
                Padding(
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 0.0),
                  child: TextFormField(
                    controller: _model.roomdesciptionTextController,
                    focusNode: _model.roomdesciptionFocusNode,
                    autofocus: true,
                    obscureText: false,
                    decoration: InputDecoration(
                      hintStyle: FlutterFlowTheme.of(context)
                    ...
                    maxLines: 3,
                    validator: _model.roomdesciptionTextControllerValidator
                        .asValidator(context),
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowPlacePicker(
                        iOSGoogleMapsApiKey:
                            'AIzaSyAebIIpLoZ2yuyDEF-QbrcyRM7ovJeCtqE',
                        androidGoogleMapsApiKey:
                            'AIzaSyBbKMN9cfxTQ_Y5k2TFe0is-TWpQBKlSf4',
                        webGoogleMapsApiKey:
                            'AIzaSyAR8kiF8FT0SvroZ9APH6zySwLvdbVoSZA',
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          var roomInfoRecordReference =
                              RoomInfoRecord.collection.doc();
                          await roomInfoRecordReference
                              .set(createRoomInfoRecordData(
                            roomName: _model.roomnameTextController.text,
                            roomAdress: _model.placePickerValue.address,
                            roomDescription:
                                _model.roomdesciptionTextController.text,
                            roomImage: _model.uploadedFileUrl,
                          ));
                          _model.tempRoomInfoDocu =
                              RoomInfoRecord.getDocumentFromData(
                                  createRoomInfoRecordData(
                                    roomName:
                                        _model.roomnameTextController.text,
                                    roomAdress: _model.placePickerValue.address,
                                    roomDescription: _model
                                        .roomdesciptionTextController.text,
                                    roomImage: _model.uploadedFileUrl,
                                  ),
                                  roomInfoRecordReference);

                          context.pushNamed(
                            'RoomStarReview',
                            queryParameters: {
                              'tempRoomInfoDocu': serializeParam(
                                _model.tempRoomInfoDocu,
                                ParamType.Document,
                              ),
                            }.withoutNulls,
                            extra: <String, dynamic>{
                              'tempRoomInfoDocu': _model.tempRoomInfoDocu,
                            },
                          );
