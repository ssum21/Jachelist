...
class AddRoomWidget extends StatefulWidget {
  const AddRoomWidget({
    super.key,
    this.propertyRef,
    this.roomimageuploaded1,
  });

  final RoomInfoRecord? propertyRef;
  final FFUploadedFile? roomimageuploaded1;
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              child: InkWell(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl: widget.propertyRef!.roomImage,
                                    width: double.infinity,
                                    height: 180.0,
                                    fit: BoxFit.cover,
                                  ),
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<RoomInfoRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<RoomInfoRecord>
                                    propertyNameRoomInfoRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final propertyNameRoomInfoRecord =
                                    propertyNameRoomInfoRecordList.isNotEmpty
                                        ? propertyNameRoomInfoRecordList.first
                                        : null;
                                return TextFormField(
                                  controller:
                                      _model.propertyNameTextController ??=
                                          TextEditingController(
                                    text: propertyNameRoomInfoRecord?.roomName,
                                  ),
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<RoomInfoRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<RoomInfoRecord>
                                    propertyAddressRoomInfoRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final propertyAddressRoomInfoRecord =
                                    propertyAddressRoomInfoRecordList.isNotEmpty
                                        ? propertyAddressRoomInfoRecordList
                                            .first
                                        : null;
                                return TextFormField(
                                  controller:
                                      _model.propertyAddressTextController ??=
                                          TextEditingController(
                                    text: propertyAddressRoomInfoRecord
                                        ?.roomAdress,
                                  ),
                          ...
                          FlutterFlowStaticMap(
                            ...
                            apiKey:
                                'pk.eyJ1Ijoic3N1bTIxIiwiYSI6ImNsd2V6dDJsZDFyb28ybG10M2prZ3dnMnIifQ.V2Rg6Gk4KCcJE_Wa1DsXhg',
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<RoomInfoRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<RoomInfoRecord>
                                    propertyDescriptionRoomInfoRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final propertyDescriptionRoomInfoRecord =
                                    propertyDescriptionRoomInfoRecordList
                                            .isNotEmpty
                                        ? propertyDescriptionRoomInfoRecordList
                                            .first
                                ...
                                return TextFormField(
                                  controller: _model
                                      ...
                                      TextEditingController(
                                    text: propertyDescriptionRoomInfoRecord
                                        ?.roomDescription,
                                  ),
                                  focusNode:
